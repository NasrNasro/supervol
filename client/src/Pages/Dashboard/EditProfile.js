...
import { editCommercialRegister, editEmailParticular, editEmailProfessional, editPassportParticular, editPasswordParticular, editPasswordProfessional, editPatentPhoto, editPhoneParticular, editPhoneProfessional, editPhotoParticular, editPhotoProfessional } from '../../redux/actions/profileActions'
                ...
                <div className="col-md-6">
                  ...
                  <div className="card card-info">
                    <div className="card-header">
                      <h3 className="card-title">Edit Informations</h3>
                    </div>
                    {/* /.card-header */}
                    {/* form start */}
                    <form>
                      <div className="card-body">
                        <div className="form-group">
                          <label htmlFor="exampleInputPhone">New phone number</label>
                          <div class="input-group mb-3">
                            <input name='phone' type="text" className="form-control" id="exampleInputPhone" placeholder="Enter phone number" onChange={handleChange} />
                            <div class="input-group-append">
                              {
                                (user && user.status==="Particular") ?
                                <button class="btn btn-info" onClick={handlePhoneParticular}><i className='fas fa-edit'> Edit</i></button>
                                :
                                <button class="btn btn-info" onClick={handlePhoneProfessional}><i className='fas fa-edit'> Edit</i></button>
                              }
                            </div>
                          </div>
                        </div>
                        <div className="form-group">
                          ...
                          <div class="input-group mb-3">
                            <input name='email' type="email" className="form-control" id="exampleInputEmail1" placeholder="Enter email" onChange={handleChange} />
                            <div class="input-group-append">
                              {
                                (user && user.status==="Particular") ?
                                <button class="btn btn-info" onClick={handleEmailParticular}><i className='fas fa-edit'> Edit</i></button>
                                :
                                <button class="btn btn-info" onClick={handleEmailProfessional}><i className='fas fa-edit'> Edit</i></button>
                              }
                            </div>
                          </div>
                        </div>
                        <div className="form-group">
                          ...
                          <div class="input-group mb-3">
                            ...
                            <div class="input-group-append">
                              {
                                (user && user.status==="Particular") ?
                                <button class="btn btn-info" onClick={handlePasswordParticular}><i className='fas fa-edit'> Edit</i></button>
                                :
                                <button class="btn btn-info" onClick={handlePasswordProfessional}><i className='fas fa-edit'> Edit</i></button>
                              }
                  ...
                  <div className="card card-success">
                    <div className="card-header">
                      <h3 className="card-title">Edit Photo</h3>
                    </div>
                    {/* /.card-header */}
                    {/* form start */}
                    <form className="form-horizontal">
                      <div className="card-body">
                        <img src={`uploads/${user&&user.imageUrl}`} alt="User" style={{marginBottom:'20px'}} />
                        <div className="form-group">
                          <label htmlFor="exampleInputFile">New Photo</label>
                          <div className="input-group">
                            <div className="custom-file">
                              <input type="file" className="custom-file-input" id="exampleInputFile" onChange={e=>setFile(e.target.files[0])}/>
                              <label className="custom-file-label" htmlFor="exampleInputFile">Choose file</label>
                            </div>
                          </div>
                          <div style={{display:'flex',justifyContent:'center', margin:'25px 0px 0px 0px'}}>
                            {
                              (user && user.status==="Particular") ?
                              <button className="btn btn-success" style={{padding:'5px 30px 5px 30px'}} onClick={handlePhotoParticular}><i className='fas fa-edit'> Edit</i></button>
                              :
                              <button className="btn btn-success" style={{padding:'5px 30px 5px 30px'}} onClick={handlePhotoProfessional}><i className='fas fa-edit'> Edit</i></button>
                            }
                          </div>
                        </div>
                ...
                <div className="col-md-6">
                  {/* Form Element sizes */}
                  {
                    (user && user.status==="Particular") ?
                      <div className="card card-success">
                        <div className="card-header">
                          <h3 className="card-title">Edit Passport Photo</h3>
                        </div>
                        <div className="card-body">
                          <img src={`uploads/${user&&user.imagePassport}`} alt="Passport" style={{marginBottom:'20px'}} />
                          <div className="form-group">
                            <label htmlFor="exampleInputFile">New Passport Photo</label>
                            <div className="input-group">
                              <div className="custom-file">
                                <input type="file" className="custom-file-input" id="exampleInputFile" onChange={e=>setFile1(e.target.files[0])}/>
                                <label className="custom-file-label" htmlFor="exampleInputFile">Choose file</label>
                              </div>
                            </div>
                            <div style={{display:'flex',justifyContent:'center', margin:'25px 0px 0px 0px'}}>
                                <button className="btn btn-success" style={{padding:'5px 30px 5px 30px'}} onClick={handlePassportParticular}><i className='fas fa-edit'> Edit</i></button>
                            </div>
                          </div>
                        </div>
                        {/* /.card-body */}
                    ...
                    <div className="card card-success">
                      <div className="card-header">
                        <h3 className="card-title">Edit Patent Photo</h3>
                      </div>
                      <div className="card-body">
                        <img src={`uploads/${user&&user.imagePatent}`} alt="Patent" style={{marginBottom:'20px'}} />
                        <div className="form-group">
                          <label htmlFor="exampleInputFile">New Patent Photo</label>
                          <div className="input-group">
                            <div className="custom-file">
                              <input type="file" className="custom-file-input" id="exampleInputFile" onChange={e=>setFile2(e.target.files[0])}/>
                              <label className="custom-file-label" htmlFor="exampleInputFile">Choose file</label>
                            </div>
                          </div>
                          <div style={{display:'flex',justifyContent:'center', margin:'25px 0px 0px 0px'}}>
                            <button className="btn btn-success" style={{padding:'5px 30px 5px 30px'}} onClick={handlePatentPhoto}><i className='fas fa-edit'> Edit</i></button>
                          </div>
                        </div>
                      </div>
                      {/* /.card-body */}
                      ...
                      <div className="card card-success">
                      <div className="card-header">
                        <h3 className="card-title">Edit Commercial Register Photo</h3>
                      </div>
                      <div className="card-body">
                        <img src={`uploads/${user&&user.imageCommercialRegister}`} alt="Commercial Register" style={{marginBottom:'20px'}} />
                        <div className="form-group">
                          <label htmlFor="exampleInputFile">New Commercial Register Photo</label>
                          <div className="input-group">
                            <div className="custom-file">
                              <input type="file" className="custom-file-input" id="exampleInputFile" onChange={e=>setFile3(e.target.files[0])}/>
                              <label className="custom-file-label" htmlFor="exampleInputFile">Choose file</label>
                            </div>
                          </div>
                          <div style={{display:'flex',justifyContent:'center', margin:'25px 0px 0px 0px'}}>
                            <button className="btn btn-success" style={{padding:'5px 30px 5px 30px'}} onClick={handleCommercialRegister}><i className='fas fa-edit'> Edit</i></button>
                          </div>
                        </div>
                      </div>
                      {/* /.card-body */}
