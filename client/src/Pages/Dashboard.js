        ...
        <aside className="main-sidebar sidebar-dark-primary elevation-4">
          ...
          <div className="sidebar">
            ...
            <div className="user-panel mt-3 pb-3 mb-3 d-flex">
              <div className="image">
                <img src={`uploads/${user&&user.imageUrl}`} className="img-circle elevation-2" alt="User Image" />
              </div>
              <div className="info">
               ...
               with font-awesome or any other icon font library */}
                ...
                <li className="nav-item menu-open">
                  ...
                  <ul className="nav nav-treeview">
                    ...
                    <li className="nav-item">
                      <a href="../examples/profile.html" className="nav-link active">
                        <i className="far fa-circle nav-icon" />
                        <p>Profile</p>
                      </a>
                    </li>
                ...
                <div className="col-md-3">
                  ...
                  <div className="card card-primary card-outline">
                    <div className="card-body box-profile">
                      <div className="text-center">
                        <img className="profile-user-img img-fluid img-circle" src={`uploads/${user&&user.imageUrl}`} alt="User profile" />
                      </div>
                      <h3 className="profile-username text-center">{user&&user.name}</h3>
                    </div>
                    {/* /.card-body */}
                  </div>
                  {/* /.card */}
                  ...
                  <div className="card card-primary">
                    ...
                    <div className="card-body">
                      <strong>Phone</strong>
                      <p className="text-muted" style={{fontSize:'1rem', fontWeight:'400'}}>
                        {user&&user.phone}
                      </p>
                      <hr />
                      ...
                      <hr />
                      <strong>{user&&user.status==='Particular' ? 'Birth' : 'Company creation date'}</strong>
                      <p className="text-muted" style={{fontSize:'1rem', fontWeight:'400'}}>
                        {user&&user.birth}
                      </p>
                      <hr />
                  ...
                  <div className="card">
                    <div className="card-header p-2">
                      <ul className="nav nav-pills">
                        <li className="nav-item"><a className="nav-link active" href="#activity" data-toggle="tab">Photo</a></li>
                        {
                          user&&user.status==="Particular" ? 
                          <li className="nav-item"><a className="nav-link" href="#timeline" data-toggle="tab">Passport</a></li>
                          :
                          <>
                          <li className="nav-item"><a className="nav-link" href="#timeline" data-toggle="tab">Patent</a></li>
                          <li className="nav-item"><a className="nav-link" href="#settings" data-toggle="tab">Commercial Register</a></li>
                          </>
                        }
                      </ul>
                    </div>{/* /.card-header */}
                    <div className="card-body">
                      <div className="tab-content">
                        <div className="active tab-pane" id="activity">
                          <img className='img-fluid' src={`uploads/${user&&user.imageUrl}`} alt='User' />
                        </div>
                        {/* /.tab-pane */}
                        <div className="tab-pane" id="timeline">
                          {
                            user&&user.status==="Particular" ? 
                            <img className='img-fluid' src={`uploads/${user&&user.imagePassport}`} alt='Passport' />
                            :
                            <img className='img-fluid' src={`uploads/${user&&user.imagePatent}`} alt='Patent' />
                          }
                        </div>
                        <div className="tab-pane" id="settings">
                          <img className='img-fluid' src={`uploads/${user&&user.imageCommercialRegister}`} alt='Commercial Register' />
                        </div>
                        {/* /.tab-pane */}
                      </div>
                      {/* /.tab-content */}
