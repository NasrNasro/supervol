...
import { registerParticular } from '../redux/actions/authActions'
import Footer from '../Components/Footer'
import Navbar from '../Components/Navbar'
import '../App.css'

function RegisterParticular() {
  const [data, setData]=useState({name:"", phone:"", birth:"", passport:"", email:"", password:""})
  ...
  const handleSubmit=e=>{
    e.preventDefault();
    dispatch(registerParticular(data,Photo,PhotoPassport,navigate))
  }
                ...
                <div className="card-body mx-auto">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group input-group">
                      ...
                      <label for="files" class="input-group-text" style={{width:'84%'}}>Import your photo</label>
                    ...
                    <div className="form-group input-group">
                      ...
                      <input name="passport" className="form-control" placeholder="Passport Number" type="text" onChange={handleChange}/>
                    </div>
                    <div className="form-group input-group">
                      <div className="input-group-prepend">
                        <span className="input-group-text"> <i className="fa fa-user" /> </span>
                      </div>
                      <label for="files1" class="input-group-text" style={{width:'84%'}}>Import passport photo</label>
                      <input id="files1" style={{display:'none'}} type="file" onChange={e=>setPhotoPassport(e.target.files[0])}></input>
                    </div>
                    <div className="form-group input-group">
                      <div className="input-group-prepend">
...
export default RegisterParticular